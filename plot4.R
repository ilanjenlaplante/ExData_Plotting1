...
##Graph 2
plot(subset_power$Concat_Date_Time, subset_power$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")
##Graph 3
...
##Graph 4
plot(subset_power$Concat_Date_Time, subset_power$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
dev.off()
